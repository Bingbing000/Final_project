...
report.html: report.Rmd clean_data/clean_data.rds output/make_table.rds output/heat_map.png output/ct.png output/bn.png output/bc.png output/ma.png output/nn.png output/un.png
